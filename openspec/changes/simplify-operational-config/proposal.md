...
- `orchestration-dashboard`: Operational data collection is a neutral shared runtime source with persisted runtime settings, UI/API-adjustable collection cadence, and no per-consumer deployment scheduler configuration.
